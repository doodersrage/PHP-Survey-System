...
if (is_array($_POST['print_letter'])) {
...
foreach($_POST['print_letter'] as $selected_letter) {
set_time_limit(30);

$current_select = explode('-',$selected_letter);

// get client and form data
$client_id = $current_select[0];
$form_id = $current_select[1];
...
echo 'You must first select the forms your want to print';
}
?>