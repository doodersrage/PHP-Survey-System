...
if (is_array($_POST['show_labels'])) {
foreach($_POST['show_labels'] as $selected_labels) {

// client query
$modify_query = "SELECT contact_salutation, contact_name, company, address1, address2, city, state, zip, phone_number, fax_number, email_address, psk FROM client_info WHERE client_id = '".$selected_labels."' ORDER BY zip ASC, contact_name ASC";
...
$pdf->Add_PDF_Label('Please select which customers you want to print labels for.');
}
